...
function wpeHeaderSubNav() {
	wp_nav_menu(
	array(
		'theme_location'  => 'header-more-menu',
		'menu'            => '', 
		'container'       => 'div', 
		'container_class' => 'menu-{menu slug}-container', 
		'container_id'    => '',
...
function register_html5_menu() {
    register_nav_menus(array( 
        'header-menu' => __('header menu', 'wpeasy'),
        'header-more-menu' => __('header more menu', 'wpeasy'),
...
function register_cpt_posters() {
    ...
    $labels = array( 
        'name' => _x( 'Афиша', 'posters' ),
        'singular_name' => _x( 'posters', 'posters' ),
        'add_new' => _x( 'Add New', 'posters' ),
        'add_new_item' => _x( 'Add New posters', 'posters' ),
        'edit_item' => _x( 'Edit posters', 'posters' ),
        'new_item' => _x( 'New posters', 'posters' ),
        'view_item' => _x( 'View posters', 'posters' ),
        'search_items' => _x( 'Search Афиша', 'posters' ),
        'not_found' => _x( 'No афиша found', 'posters' ),
        'not_found_in_trash' => _x( 'No афиша found in Trash', 'posters' ),
        'parent_item_colon' => _x( 'Parent posters:', 'posters' ),
        'menu_name' => _x( 'Афиша', 'posters' ),
    );
